...
if __name__ == "__main__":
    ...
    try:
        ...
        for index,_ in enumerate(range(5), start=1): #range(2458):
            ...
            query = "SELECT Date_Year,Volume,serials.Code,serials.accession,Serial_Title,ISSN,Agent,Subject FROM serials left join  serial_title on serials.code = serial_title.code;"
